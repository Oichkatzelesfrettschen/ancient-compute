...
_LANGUAGE_CAPABILITIES: tuple[LanguageCapability, ...] = (
    ...
    LanguageCapability(
        ...
        description="LISP parser/compiler path with placeholder execution",
        aliases=("lisp",),
        timeout=10,
        memory_limit_mb=256,
        implementation_status="partial",
        execution_mode="compile_stub",
    ...
    LanguageCapability(
        ...
        name="IDRIS2",
        version="0.6.0 (stub)",
        description="IDRIS2 service skeleton; execution path not implemented",
    ...
    LanguageCapability(
        id="systemf",
        name="System F",
        version="Academic (stub)",
        description="System F service skeleton; execution path not implemented",
