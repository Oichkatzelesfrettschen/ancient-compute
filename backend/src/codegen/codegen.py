...
from backend.src.codegen.regalloc import AllocationMap, LinearScanAllocator
...
class CodeGenerator:
    ...
    def generate_function(self, function: Function, verbose: bool = False) -> CodeGenResult:
        ...
        if verbose:
            print("[CODEGEN] Phase 1: Liveness analysis...")
        ...
        if verbose:
            print("[CODEGEN] Phase 2: Register allocation...")
        ...
        if verbose:
            print("[CODEGEN] Phase 3: Instruction selection...")
        ...
        if verbose:
            print("[CODEGEN] Phase 4: Code emission...")
