...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "lesson_type",
            sa.Enum("READING", "INTERACTIVE", "CODING", "QUIZ", "SYNTHESIS", name="lessontype"),
            nullable=False,
        ),
        sa.Column("sequence_order", sa.Integer(), nullable=False),
        sa.Column("description", sa.Text(), nullable=False),
    ...
    op.create_index(
        op.f("ix_module_progress_module_id"), "module_progress", ["module_id"], unique=False
    )
    op.create_index(
        op.f("ix_module_progress_user_id"), "module_progress", ["user_id"], unique=False
    )
    op.create_table(
        "code_submissions",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_code_submissions_lesson_id"), "code_submissions", ["lesson_id"], unique=False
    )
    op.create_index(
        op.f("ix_code_submissions_user_id"), "code_submissions", ["user_id"], unique=False
    )
    op.create_table(
        "exercise_progress",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_exercise_progress_exercise_id"), "exercise_progress", ["exercise_id"], unique=False
    )
    op.create_index(op.f("ix_exercise_progress_id"), "exercise_progress", ["id"], unique=False)
    op.create_index(
        op.f("ix_exercise_progress_user_id"), "exercise_progress", ["user_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_exercise_submissions_exercise_id"),
        "exercise_submissions",
        ["exercise_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_exercise_submissions_id"), "exercise_submissions", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_exercise_submissions_user_id"), "exercise_submissions", ["user_id"], unique=False
    )
    op.create_table(
        "lesson_progress",
        sa.Column("id", sa.Integer(), nullable=False),
