...
class TestPolynomialExecution:
    ...
    def test_execute_linear_polynomial(self):
        ...
        response = client.post(
            ...
            json={"coefficients": [1, 2], "x_range": [1, 5], "execution_speed": 1.0},
        )
    ...
    def test_execute_single_value(self):
        ...
        response = client.post(
            "/api/v1/emulator/execute",
            json={"coefficients": [1, 2], "x_range": [3, 3], "execution_speed": 1.0},
        )
    ...
    def test_execute_includes_phase_info(self):
        ...
        response = client.post(
            "/api/v1/emulator/execute",
            json={"coefficients": [1, 2], "x_range": [1, 2], "execution_speed": 1.0},
        )
...
class TestDebugger:
    ...
    def test_set_cycle_breakpoint(self):
        ...
        response = client.post(
            "/api/v1/emulator/debug/breakpoint", json={"type": "CYCLE", "cycle_target": 100}
        )
    ...
    def test_set_phase_breakpoint(self):
        ...
        response = client.post(
            "/api/v1/emulator/debug/breakpoint", json={"type": "PHASE", "phase_target": "CARRY"}
        )
    ...
    def test_set_value_change_breakpoint(self):
        ...
        response = client.post(
            ...
            json={"type": "VALUE_CHANGE", "variable_name": "accumulator"},
        )
    ...
    def test_enable_breakpoint(self):
        ...
        bp_response = client.post(
            "/api/v1/emulator/debug/breakpoint", json={"type": "CYCLE", "cycle_target": 50}
        )
    ...
    def test_define_variable(self):
        ...
        response = client.post(
            "/api/v1/emulator/debug/variable", json={"name": "myvar", "value": 42}
        )
    ...
    def test_set_variable_value(self):
        ...
        # Define variable
        client.post("/api/v1/emulator/debug/variable", json={"name": "myvar", "value": 42})

        # Update it
        response = client.put(
            "/api/v1/emulator/debug/variable/myvar", json={"name": "myvar", "value": 100}
        )
    ...
    def test_debug_continue_execution(self):
        ...
        response = client.post("/api/v1/emulator/debug/continue", json={"max_cycles": 50})
...
class TestStateConsistency:
    ...
    def test_state_persists_after_execution(self):
        ...
        client.post(
            "/api/v1/emulator/execute",
            json={"coefficients": [1, 2], "x_range": [1, 3], "execution_speed": 1.0},
        )
...
class TestErrorHandling:
    ...
    def test_invalid_breakpoint_type(self):
        ...
        response = client.post("/api/v1/emulator/debug/breakpoint", json={"type": "INVALID_TYPE"})
    ...
    def test_empty_coefficient_array(self):
        ...
        response = client.post(
            "/api/v1/emulator/execute",
            json={"coefficients": [], "x_range": [1, 5], "execution_speed": 1.0},
        )
