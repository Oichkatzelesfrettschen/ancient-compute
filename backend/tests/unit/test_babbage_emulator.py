...
def test_engine_jmp():
    engine = Engine()
    engine.instruction_cards = [Instruction('NOP'), Instruction('JMP', ['5']), Instruction('NOP'), Instruction('NOP'), Instruction('NOP'), Instruction('NOP')]
    engine.PC = 0
...
def test_engine_jz_true():
    ...
    engine.instruction_cards = [Instruction('NOP'), Instruction('JZ', ['5']), Instruction('NOP'), Instruction('NOP'), Instruction('NOP'), Instruction('NOP')]
    engine.PC = 0
    engine.execute_instruction(engine.instruction_cards[0]) # NOP
