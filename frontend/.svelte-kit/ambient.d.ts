...
declare module '$env/dynamic/private' {
	export const env: {
		...
		OLDPWD: string;
		OLLAMA_BATCH_SIZE: string;
		OLLAMA_FLASH_ATTENTION: string;
		OLLAMA_GPU_MEMORY: string;
		OLLAMA_GPU_MEMORY_FRACTION: string;
