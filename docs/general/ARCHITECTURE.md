...
**See the original full document in the root directory at: `ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md`**

This summary provides key architectural decisions. For complete technical details, reference:
- `./PROJECT_STRUCTURE.md` - Directory organization
- `BACKEND_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md` - FastAPI backend specifics
- `FRONTEND_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md` - SvelteKit frontend specifics
- `DATABASE_SCHEMA.md` - Data model
- `API_SPECIFICATION.md` - REST/WebSocket endpoints
- `SECURITY_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md` - Security and sandboxing
...
- [BACKEND_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md](BACKEND_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md) - FastAPI details
- [FRONTEND_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md](FRONTEND_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md) - SvelteKit details
- [SECURITY_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md](SECURITY_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md) - Security model
