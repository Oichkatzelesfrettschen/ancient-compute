...
│   ├── ARCHITECTURE_AND_DESIGN/PROJECT_STRUCTURE.md      # This file
│   ├── BACKEND_./ARCHITECTURE.md   # FastAPI backend specifics
│   ├── FRONTEND_./ARCHITECTURE.md  # SvelteKit frontend specifics
│   ├── DATABASE_SCHEMA.md        # Data model
│   ├── API_SPECIFICATION.md      # REST/WebSocket endpoints
│   ├── SECURITY_./ARCHITECTURE.md  # Security & sandboxing
...
├── ./ARCHITECTURE.md              # Complete technical architecture
├── ARCHITECTURE_AND_DESIGN/PROJECT_STRUCTURE.md         # This file - directory organization
├── BACKEND_./ARCHITECTURE.md      # FastAPI, SQLAlchemy, async
├── FRONTEND_./ARCHITECTURE.md     # SvelteKit, Monaco Editor, D3.js
├── DATABASE_SCHEMA.md           # Tables, relationships, migrations
├── API_SPECIFICATION.md         # REST endpoints, WebSocket events
├── SECURITY_./ARCHITECTURE.md     # Sandboxing, isolation, threat model
├── ./IMPLEMENTATION_ROADMAP.md    # 52-week development plan
