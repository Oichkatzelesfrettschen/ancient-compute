...
```markdown
[See DEVELOPMENT_GUID../DEVELOPMENT_GUIDES/docs/general/BUILD.md](docs/general/BUILD.md)
[Check ../docs/general/ARCHITECTURE.md](docs/general/ARCHITECTURE.md)
```

Needs updating to:
```markdown
[See DEVELOPMENT_GUID../DEVELOPMENT_GUIDES/docs/general/BUILD.md](../DEVELOPMENT_GUIDdocs/general/BUILD.md)
[Check ../docs/general/ARCHITECTURE.md](../docs/general/ARCHITECTURE.md)
```
...
Example old reference:
```markdown
[Manufacturing specs](docs/babbage_engine/OPTIMAL_BABBAGE_SPECIFICATION.md)
[Curriculum](docs/general/DOCUMENT_FINDER.md)
```
...
Example old reference:
```markdown
[Infrastructure guide](docs/general/INFRASTRUCTURE_STRATEGY.md)
```
...
Example old reference:
```markdown
[Whitepaper summary](docs/whitepaper/WHITEPAPER_DELIVERY_SUMMARY.md)
```
...
Example old reference:
```markdown
[Phase 3 procedures](docs/archive/PHASE_3/PHASE3_MANUFACTURING_PROCEDURES.md)
[Phase 4 validation](docs/archive/PHASE_4/PHASE4_SYSTEM_OPERATIONAL_VALIDATION.md)
```
...
| Old Path | New Path |
|----------|----------|
| DEVELOPMENT_GUID../DEVELOPMENT_GUIDES/docs/general/BUILD.md | DEVELOPMENT_GUIDdocs/general/BUILD.md |
...
| Old Path | New Path |
|----------|----------|
| LANGUAGE_SERVICES_../docs/general/ARCHITECTURE.md | ARCHITECTURE_AND_DESIGN/LANGUAGE_SERVICES_../docs/general/ARCHITECTURE.md |
...
| docs/whitepaper-arxiv/WHITEPAPER_DELIVERY_SUMMARY.md | BABBAGE_ANALYTICAL_ENGINE/BABBAGE_ANALYTICAL_ENGINE/docs/whitepaper/WHITEPAPER_DELIVERY_SUMMARY.md |
...
| Old Path | New Path |
|----------|----------|
| docs/general/HISTORICAL_AUDIT_AND_CORRECTIONS.md | docs/general/HISTORICAL_AUDIT_AND_CORRECTIONS.md |
...
| docs/specifications/docs/specifications/BSD_INTEGRATION_SPEC.md | docs/specifications/docs/specifications/BSD_INTEGRATION_SPEC.md |
...
| docs/archive/SIMULATOR_RESEARCH_NOTES.md | ARCHIVED_AND_LEGACY/SIMULATOR_RESEARCH_NOTES.md |
| docs/archive/PHASE2_DELIVERY_SUMMARY.md | ARCHIVED_AND_LEGACY/PHASE2_DELIVERY_SUMMARY.md |
...
grep -r '\[.*\](docs/general/DOCUMENT_FINDER.md)' . --include="*.md" | sort | uniq > LINKS_FOUND.txt

# Output format: filename:line_number:[link_text(docs/general/DOCUMENT_FINDER.md)
```
...
s|BUILD\.md|DEVELOPMENT_GUIDdocs/general/BUILD.md|g
...
s|docs/OPTIMAL_BABBAGE_SPECIFICATION\.md|docs/babbage_engine/OPTIMAL_BABBAGE_SPECIFICATION.md|g
s|docs/SUPPLY_CHAIN_PROCUREMENT_GUIDE\.md|BABBAGE_ANALYTICAL_ENGINE/SUPPLY_CHAIN_PROCUREMENT_GUIDE.md|g
s|docs/BABBAGEdocs/general/DOCUMENT_FINDER.md|BABBAGE_ANALYTICAL_ENGINE/&|g

# infrastructure/ files
s|infrastructure/INFRASTRUCTURE_STRATEGY\.md|docs/general/INFRASTRUCTURE_STRATEGY.md|g
s|infrastructure/BSD_INTEGRATION_SPEC\.md|docs/specifications/docs/specifications/BSD_INTEGRATION_SPEC.md|g

# phase files
s|IMPLEMENTATION_PHASES/PHASE_3/\(docs/general/DOCUMENT_FINDER.md\)|IMPLEMENTATION_PHASES/PHASE_3/\1|g
s|IMPLEMENTATION_PHASES/PHASE_4/\(docs/general/DOCUMENT_FINDER.md\)|IMPLEMENTATION_PHASES/PHASE_4/\1|g

# whitepaper files
s|whitepaper/WHITEPAPER_DELIVERY_SUMMARY\.md|BABBAGE_ANALYTICAL_ENGINE/BABBAGE_ANALYTICAL_ENGINE/docs/whitepaper/WHITEPAPER_DELIVERY_SUMMARY.md|g
EOF
```
...
2. Check key navigation files:
   ...
   - docs/general/DOCUMENT_FINDER.md
...
for file in $(find . -name "*.md" -type f); do
  ...
  grep -o '\[.*\](docs/general/DOCUMENT_FINDER.md)' "$file" | sed 's/.*(\(.*\)).*/\1/' | while read path; do
...
**Current**: `[File](docs/general/BUILD.md)`
**Updated**: `[File](../DEVELOPMENT_GUIDdocs/general/BUILD.md)`
**Tool**: sed with relative path handling

### Type 2: Full Path Links
**Current**: `[File](docs/babbage_engine/OPTIMAL_BABBAGE_SPECIFICATION.md)`
**Updated**: `[File](docs/babbage_engine/OPTIMAL_BABBAGE_SPECIFICATION.md)`
**Tool**: sed with full path replacement

### Type 3: Deep Links (within same directory)
**Current**: `[File](docs/general/DOCUMENT_FINDER.md)`
**Updated**: `[File](docs/general/DOCUMENT_FINDER.md)` (no change)
**Tool**: No update needed

### Type 4: Cross-Directory Links
**Current**: `[File](docs/general/DOCUMENT_FINDER.md)`
**Updated**: `[File](docs/general/DOCUMENT_FINDER.md)` (may need depth adjustment)
