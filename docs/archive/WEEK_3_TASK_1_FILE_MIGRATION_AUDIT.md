...
|------|--------|--------|--------|
| ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md | DUPLICATE | Keep ../ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md, delete root copy | DELETE |
| ARCHITECTURE_AND_DESIGN/PROJECT_STRUCTURE.md | DUPLICATE | Keep ../ARCHITECTURE_AND_DESIGN/PROJECT_STRUCTURE.md, delete root copy | DELETE |
| ARCHITECTURE_AND_DESIGN/IMPLEMENTATION_ROADMAP.md | DUPLICATE | Keep ../ARCHITECTURE_AND_DESIGN/IMPLEMENTATION_ROADMAP.md, delete root copy | DELETE |

### Files to migrate to DEVELOPMENT_GUIDES/:
| File | Status | Action | Target |
|------|--------|--------|--------|
| DEVELOPMENT_GUIDES/BUILD.md | Core doc | Move to DEVELOPMENT_GUIDES/ | MOVE |
| INFRASTRUCTURE_AND_DEPLOYMENT/DOCKER_INFRASTRUCTURE.md | Deployment doc | Move to DEVELOPMENT_GUIDES/ or INFRASTRUCTURE_AND_DEPLOYMENT/ | MOVE |
| DEVELOPMENT_GUIDES/LANGUAGE_SERVICE_SPECIFICATION.md | Development spec | Move to DEVELOPMENT_GUIDES/ | MOVE |
| LANGUAGE_SERVICES_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md | Architecture doc | Move to DEVELOPMENT_GUIDES/ or ARCHITECTURE_AND_DESIGN/ | MOVE |
| DEVELOPMENT_GUIDES/WEEK_1_CHECKLIST.md | Workflow doc | Move to DEVELOPMENT_GUIDES/ | MOVE |
| DEVELOPMENT_GUIDES/WEEK_2_IMPLEMENTATION_PLAN.md | Planning doc | Move to DEVELOPMENT_GUIDES/ | MOVE |

### Files to migrate to CURRICULUM_AND_CONTENT/:
| File | Status | Action | Target |
|------|--------|--------|--------|
| CURRICULUM_AND_CONTENT/TYPE_THEORY_CURRICULUM.md | Curriculum doc | Move to CURRICULUM_AND_CONTENT/ | MOVE |
| CURRICULUM_AND_CONTENT/CONTENT_SCHEMA_DESIGN.md | Schema doc | Move to CURRICULUM_AND_CONTENT/ | MOVE |
| CURRICULUM_AND_CONTENT/PEDAGOGICAL_WHITEPAPER_COMPLETION_SUMMARY.md | Content summary | Move to CURRICULUM_AND_CONTENT/ | MOVE |

### Files to migrate to HISTORICAL_CONTEXT/:
| File | Status | Action | Target |
|------|--------|--------|--------|
| HISTORICAL_CONTEXT/TIMELINE_VISUALIZATION.md | Timeline doc | Move to HISTORICAL_CONTEXT/ | MOVE |
| HISTORICAL_CONTEXT/TIMELINE_VISUALIZATION_SPEC.md | Timeline spec | Move to HISTORICAL_CONTEXT/ | MOVE |

### Files to migrate to IMPLEMENTATION_PHASES/:
| File | Status | Action | Target |
|------|--------|--------|--------|
| IMPLEMENTATION_PHASES/PHASE2_COMPLETION_INDEX.md | Phase doc | Move to IMPLEMENTATION_PHASES/ | MOVE |
| DOCUMENTATION_SYNTHESIS_AND_REORGANIZATION_PLAN.md | Planning doc | Move to DOCUMENTATION_AND_ORGANIZATION/ | MOVE |
| IMPLEMENTATION_PHASES/BUILD_INFRASTRUCTURE_COMPLETION_SUMMARY.md | Summary doc | Move to IMPLEMENTATION_PHASES/ | MOVE |
...
| ARCHIVED_AND_LEGACY/MVP_FILE_STRUCTURE.md | Obsolete/reference | Move to ARCHIVED_AND_LEGACY/ | ARCHIVE |
| DOCUMENTATION_AND_REORGANIZATION_COMPLETION_SUMMARY.md | Summary | Keep in root (key summary) | KEEP |
| ARCHIVED_AND_LEGACY/README_OUTPUT.md | Output doc | Move to ARCHIVED_AND_LEGACY/ | ARCHIVE |
...
- ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md (root - DUPLICATE)
...
- ARCHITECTURE_AND_DESIGN/PROJECT_STRUCTURE.md (root - DUPLICATE)
...
- ARCHITECTURE_AND_DESIGN/IMPLEMENTATION_ROADMAP.md (root - DUPLICATE)
- ../ARCHITECTURE_AND_DESIGN/IMPLEMENTATION_ROADMAP.md (canonical)
**Action**: Delete root duplicate, keep canonical
**Target**: ARCHITECTURE_AND_DESIGN/

### Overlap 5: Phase Completions (multiple)
- IMPLEMENTATION_PHASES/PHASE2_COMPLETION_INDEX.md (root)
- IMPLEMENTATION_PHASES/PHASE_3/PHASE3_COMPLETION_INDEX.md (in /phase3/)
- IMPLEMENTATION_PHASES/PHASE_4/PHASE4_COMPLETION_INDEX.md (in /phase4/)
...
2. Delete duplicate ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md, ARCHITECTURE_AND_DESIGN/PROJECT_STRUCTURE.md, ARCHITECTURE_AND_DESIGN/IMPLEMENTATION_ROADMAP.md
...
mv "${PROJECT_ROO../DEVELOPMENT_GUIDES/DEVELOPMENT_GUIDES/BUILD.md" "${PROJECT_ROOT}/DEVELOPMENT_GUIDES/" 2>/dev/null || true
mv "${PROJECT_ROO../DEVELOPMENT_GUIDES/DEVELOPMENT_GUIDES/LANGUAGE_SERVICE_SPECIFICATION.md" "${PROJECT_ROOT}/DEVELOPMENT_GUIDES/" 2>/dev/null || true
mv "${PROJECT_ROO../DEVELOPMENT_GUIDES/DEVELOPMENT_GUIDES/WEEK_1_CHECKLIST.md" "${PROJECT_ROOT}/DEVELOPMENT_GUIDES/" 2>/dev/null || true
mv "${PROJECT_ROO../DEVELOPMENT_GUIDES/DEVELOPMENT_GUIDES/WEEK_2_IMPLEMENTATION_PLAN.md" "${PROJECT_ROOT}/DEVELOPMENT_GUIDES/" 2>/dev/null || true

# To INFRASTRUCTURE_AND_DEPLOYMENT/
mv "${PROJECT_ROO../../INFRASTRUCTURE_AND_DEPLOYMENT/DOCKER_INFRASTRUCTURE.md" "${PROJECT_ROOT}/INFRASTRUCTURE_AND_DEPLOYMENT/" 2>/dev/null || true

# To CURRICULUM_AND_CONTENT/
mv "${PROJECT_ROO../../CURRICULUM_AND_CONTENT/TYPE_THEORY_CURRICULUM.md" "${PROJECT_ROOT}/CURRICULUM_AND_CONTENT/" 2>/dev/null || true
mv "${PROJECT_ROO../../CURRICULUM_AND_CONTENT/CONTENT_SCHEMA_DESIGN.md" "${PROJECT_ROOT}/CURRICULUM_AND_CONTENT/" 2>/dev/null || true
mv "${PROJECT_ROO../../CURRICULUM_AND_CONTENT/PEDAGOGICAL_WHITEPAPER_COMPLETION_SUMMARY.md" "${PROJECT_ROOT}/CURRICULUM_AND_CONTENT/" 2>/dev/null || true

# To HISTORICAL_CONTEXT/
mv "${PROJECT_ROO../HISTORICAL_CONTEXT/HISTORICAL_CONTEXT/TIMELINE_VISUALIZATION.md" "${PROJECT_ROOT}/HISTORICAL_CONTEXT/" 2>/dev/null || true
mv "${PROJECT_ROO../HISTORICAL_CONTEXT/HISTORICAL_CONTEXT/TIMELINE_VISUALIZATION_SPEC.md" "${PROJECT_ROOT}/HISTORICAL_CONTEXT/" 2>/dev/null || true

# To ARCHITECTURE_AND_DESIGN/
mv "${PROJECT_ROOT}/LANGUAGE_SERVICES_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md" "${PROJECT_ROOT}/ARCHITECTURE_AND_DESIGN/" 2>/dev/null || true
...
mv "${PROJECT_ROO../IMPLEMENTATION_PHASES/IMPLEMENTATION_PHASES/PHASE2_COMPLETION_INDEX.md" "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/" 2>/dev/null || true
mv "${PROJECT_ROO../IMPLEMENTATION_PHASES/IMPLEMENTATION_PHASES/BUILD_INFRASTRUCTURE_COMPLETION_SUMMARY.md" "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/" 2>/dev/null || true

# Delete duplicates
rm -f "${PROJECT_ROO../../ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md" 2>/dev/null || true
rm -f "${PROJECT_ROO../../ARCHITECTURE_AND_DESIGN/PROJECT_STRUCTURE.md" 2>/dev/null || true
rm -f "${PROJECT_ROO../../ARCHITECTURE_AND_DESIGN/IMPLEMENTATION_ROADMAP.md" 2>/dev/null || true

# Archive old files
mv "${PROJECT_ROO../../ARCHIVED_AND_LEGACY/MVP_FILE_STRUCTURE.md" "${PROJECT_ROOT}/ARCHIVED_AND_LEGACY/" 2>/dev/null || true
mv "${PROJECT_ROO../../ARCHIVED_AND_LEGACY/README_OUTPUT.md" "${PROJECT_ROOT}/ARCHIVED_AND_LEGACY/" 2>/dev/null || true
...
# To BABBAGE_ANALYTICAL_ENGINE/
mv "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/BABBAGE_README.md" "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/" 2>/dev/null || true
mv "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/BABBAGE_PROJECT_SUMMARY.md" "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/" 2>/dev/null || true
mv "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/BABBAGE_CRITICAL_REVIEW.md" "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/" 2>/dev/null || true
mv "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/OPTIMAL_BABBAGE_SPECIFICATION.md" "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/" 2>/dev/null || true
mv "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/SUPPLY_CHAIN_PROCUREMENT_GUIDE.md" "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/" 2>/dev/null || true
mv "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/OPERATIONS_AND_MAINTENANCE.md" "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/" 2>/dev/null || true
mv "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/EMULATOR_SPECIFICATION.md" "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/" 2>/dev/null || true
mv "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/EMULATOR_USER_GUIDE.md" "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/" 2>/dev/null || true
mv "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/ASSEMBLY_INSTRUCTIONS_PART1.md" "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/" 2>/dev/null || true
mv "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/ECONOMIC_MODELS_MASS_PRODUCTION.md" "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/" 2>/dev/null || true

# To CURRICULUM_AND_CONTENT/
mv "${PROJECT_ROOT}/CURRICULUM_AND_CONTENT/EDUCATIONAL_CURRICULUM_MATERIALS.md" "${PROJECT_ROOT}/CURRICULUM_AND_CONTENT/" 2>/dev/null || true
mv "${PROJECT_ROOT}/docs/EDUCATIONAL_CURRICULUM_MATERIALS_PART2.md" "${PROJECT_ROOT}/CURRICULUM_AND_CONTENT/" 2>/dev/null || true
mv "${PROJECT_ROOT}/CURRICULUM_AND_CONTENT/EXAMPLE_PROGRAMS.md" "${PROJECT_ROOT}/CURRICULUM_AND_CONTENT/" 2>/dev/null || true

# To HISTORICAL_CONTEXT/
mv "${PROJECT_ROOT}/HISTORICAL_CONTEXT/HISTORICAL_AUDIT_AND_CORRECTIONS.md" "${PROJECT_ROOT}/HISTORICAL_CONTEXT/" 2>/dev/null || true
mv "${PROJECT_ROOT}/HISTORICAL_CONTEXT/HISTORICAL_FICTION_NARRATIVES.md" "${PROJECT_ROOT}/HISTORICAL_CONTEXT/" 2>/dev/null || true
...
if [ -d "${PROJECT_ROOT}/infrastructure" ]; then
  mv "${PROJECT_ROOT}/INFRASTRUCTURE_AND_DEPLOYMENT/INFRASTRUCTURE_STRATEGY.md" "${PROJECT_ROOT}/INFRASTRUCTURE_AND_DEPLOYMENT/" 2>/dev/null || true
  mv "${PROJECT_ROOT}/INFRASTRUCTURE_AND_DEPLOYMENT/BSD_INTEGRATION_SPEC.md" "${PROJECT_ROOT}/INFRASTRUCTURE_AND_DEPLOYMENT/" 2>/dev/null || true
...
if [ -d "${PROJECT_ROOT}/phase3" ]; then
  ...
  if [ -d "${PROJECT_ROOT}/phase3/procedures" ]; then
    mv "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/PHASE_3/procedures"/*.md "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/PHASE_3/" 2>/dev/null || true
  fi
  if [ -d "${PROJECT_ROOT}/phase3/specifications" ]; then
    mv "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/PHASE_3/specifications"/*.md "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/PHASE_3/" 2>/dev/null || true
  fi
fi
...
if [ -d "${PROJECT_ROOT}/phase4" ]; then
  ...
  if [ -d "${PROJECT_ROOT}/phase4/testing" ]; then
    mv "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/PHASE_4/testing"/*.md "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/PHASE_4/" 2>/dev/null || true
  fi
  if [ -d "${PROJECT_ROOT}/phase4/acceptance" ]; then
    mv "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/PHASE_4/acceptance"/*.md "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/PHASE_4/" 2>/dev/null || true
  fi
  if [ -d "${PROJECT_ROOT}/phase4/validation" ]; then
    mv "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/PHASE_4/validation"/*.md "${PROJECT_ROOT}/IMPLEMENTATION_PHASES/PHASE_4/" 2>/dev/null || true
  fi
fi
...
if [ -d "${PROJECT_ROOT}/whitepaper" ]; then
  ...
  mv "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/whitepaper/WHITEPAPER_DELIVERY_SUMMARY.md" "${PROJECT_ROOT}/BABBAGE_ANALYTICAL_ENGINE/whitepaper/" 2>/dev/null || true
...
1. README.md (KEEP)
2. CLAUDE.md (KEEP)
3. ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md (DELETE - duplicate)
4. AGENTS.md (DECISION NEEDED)
5. DEVELOPMENT_GUIDES/BUILD.md → DEVELOPMENT_GUIDES/
6. INFRASTRUCTURE_AND_DEPLOYMENT/DOCKER_INFRASTRUCTURE.md → INFRASTRUCTURE_AND_DEPLOYMENT/
7. DEVELOPMENT_GUIDES/SECURITY_LAYERS_IMPLEMENTATION.md (TO CATEGORIZE)
8. CURRICULUM_AND_CONTENT/TYPE_THEORY_CURRICULUM.md → CURRICULUM_AND_CONTENT/
9. LANGUAGE_SERVICES_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md → ARCHITECTURE_AND_DESIGN/
10. DEVELOPMENT_GUIDES/WEEK_1_CHECKLIST.md → DEVELOPMENT_GUIDES/
11. DEVELOPMENT_GUIDES/WEEK_2_IMPLEMENTATION_PLAN.md → DEVELOPMENT_GUIDES/
12. DEVELOPMENT_GUIDES/LANGUAGE_SERVICE_SPECIFICATION.md → DEVELOPMENT_GUIDES/
13. ARCHITECTURE_AND_DESIGN/IMPLEMENTATION_ROADMAP.md (DELETE - duplicate)
14. ARCHIVED_AND_LEGACY/MVP_FILE_STRUCTURE.md → ARCHIVED_AND_LEGACY/
15. HISTORICAL_CONTEXT/TIMELINE_VISUALIZATION.md → HISTORICAL_CONTEXT/
16. HISTORICAL_CONTEXT/TIMELINE_VISUALIZATION_SPEC.md → HISTORICAL_CONTEXT/
17. CURRICULUM_AND_CONTENT/CONTENT_SCHEMA_DESIGN.md → CURRICULUM_AND_CONTENT/
18. ARCHITECTURE_AND_DESIGN/PROJECT_STRUCTURE.md (DELETE - duplicate)
19. SOURCE_CODE_AND_BUILD_AUDIT.md → ARCHITECTURE_AND_DESIGN/
20. CURRICULUM_AND_CONTENT/PEDAGOGICAL_WHITEPAPER_COMPLETION_SUMMARY.md → CURRICULUM_AND_CONTENT/
...
23. IMPLEMENTATION_PHASES/BUILD_INFRASTRUCTURE_COMPLETION_SUMMARY.md → IMPLEMENTATION_PHASES/
24. DOCUMENTATION_AND_REORGANIZATION_COMPLETION_SUMMARY.md (KEEP - key summary)
25. ARCHIVED_AND_LEGACY/README_OUTPUT.md → ARCHIVED_AND_LEGACY/
26. IMPLEMENTATION_PHASES/PHASE2_COMPLETION_INDEX.md → IMPLEMENTATION_PHASES/
