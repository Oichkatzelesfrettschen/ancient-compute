...
A shared interface contract is defined in
\texttt{docs/simulation/EMULATOR\_INTERFACE.md} to keep these models testable and
consistent. See \texttt{docs/simulation/EMULATOR\_COVERAGE\_MATRIX.md} for
current implementation status and target fidelity.
