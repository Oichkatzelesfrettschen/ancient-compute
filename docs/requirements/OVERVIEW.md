...
Backend: [backend/requirements.txt](backend/requirements.txt) (FastAPI, SQLAlchemy, Redis, testing)
  - For detailed backend requirements, see [docs/requirements/BACKEND.md](docs/requirements/BACKEND.md)
...
Frontend: [docs/requirements/FRONTEND.md](docs/requirements/FRONTEND.md) (Node/Pnpm/Vite/Svelte)

Services: [docs/requirements/SERVICES.md](docs/requirements/SERVICES.md) (Docker, per-language containers)

Docs tooling: [docs/requirements/DOCS_TOOLING.md](docs/requirements/DOCS_TOOLING.md) (LaTeX, TikZ, arXiv build)
