...
│
├── ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md (PRIMARY)
│   ├── Tech stack overview
...
│   └── Extensibility
│
├── BACKEND_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md
...
│
├── FRONTEND_ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md
│   ├── SvelteKit & routing
│   ├── Component structure
│   ├── State management
...
│   └── Incident response
│
├── ARCHITECTURE_AND_DESIGN/IMPLEMENTATION_ROADMAP.md (PRIMARY)
│   ├── 52-week phased plan
...
- ARCHITECTURE_AND_DESIGN/ARCHITECTURE.md references phase-specific details
