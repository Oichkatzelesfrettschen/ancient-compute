...
2. `ARCHITECTURE.md` - Complete technical architecture (766 lines, 40 KB) ⭐ PRIMARY
3. `PROJECT_STRUCTURE.md` - Directory organization (468 lines, 15 KB)
4. `IMPLEMENTATION_ROADMAP.md` - 52-week development plan (482 lines, 18 KB) ⭐ PRIMARY
...
7. `LANGUAGE_SERVICES_ARCHITECTURE.md` - Language service design
8. `LANGUAGE_SERVICE_SPECIFICATION.md` - Service interface spec
9. `SECURITY_LAYERS_IMPLEMENTATION.md` - Security architecture
10. `DOCKER_INFRASTRUCTURE.md` - Container setup
11. `CONTENT_SCHEMA_DESIGN.md` - Content data model

**Category D: Educational Curriculum Content**
12. `TYPE_THEORY_CURRICULUM.md` - Type theory teaching material
13. `TIMELINE_VISUALIZATION.md` - Timeline design
14. `TIMELINE_VISUALIZATION_SPEC.md` - Timeline specification

**Category E: Development Progress & Checklists**
15. `WEEK_1_CHECKLIST.md` - Week 1 progress
16. `WEEK_2_IMPLEMENTATION_PLAN.md` - Week 2 planning
17. `ARCHITECTURAL_REVIEW_WEEK2_DAY6.md` - Code review findings
18. `MVP_FILE_STRUCTURE.md` - MVP structure template

**Category F: Build Infrastructure & Deliverables**
19. `BUILD.md` - Build system documentation (449 lines)
20. `BUILD_INFRASTRUCTURE_COMPLETION_SUMMARY.md` - Build completion summary
21. `README_OUTPUT.md` - Output directory description
22. `PEDAGOGICAL_WHITEPAPER_COMPLETION_SUMMARY.md` - Whitepaper completion
23. `PHASE2_COMPLETION_INDEX.md` - Phase 2 completion index
...
2. `docs/BABBAGE_PROJECT_SUMMARY.md` - Executive summary (609 lines, 22 KB) ⭐ PRIMARY
3. `docs/BABBAGE_README.md` - Quick reference guide (310 lines, 11 KB)
...
6. `docs/OPTIMAL_BABBAGE_SPECIFICATION.md` - Full spec (1,566 lines, 58 KB) ⭐ PRIMARY
7. `docs/BABBAGE_CRITICAL_REVIEW.md` - Detailed review (700+ lines, 32 KB)

**Category I: Historical & Accuracy Documents**
8. `docs/HISTORICAL_AUDIT_AND_CORRECTIONS.md` - Historical verification (4,500 lines, 85 KB) ⭐ PRIMARY
9. `docs/HISTORICAL_FICTION_NARRATIVES.md` - Historical narratives

**Category J: Manufacturing & Operations (Phase 0-1)**
10. `docs/MANUFACTURING_THIRD_WORLD.md` - Regional manufacturing analysis
11. `docs/ECONOMIC_MODELS_MASS_PRODUCTION.md` - Economic models
12. `docs/SUPPLY_CHAIN_PROCUREMENT_GUIDE.md` - Supply chain analysis
13. `docs/ASSEMBLY_INSTRUCTIONS_PART1.md` - Assembly guide

**Category K: Programming & Emulation (Phase 1)**
14. `docs/EXAMPLE_PROGRAMS.md` - Program examples
15. `docs/OPERATIONS_AND_MAINTENANCE.md` - Operations guide
16. `docs/EMULATOR_SPECIFICATION.md` - Software emulator spec
17. `docs/EMULATOR_USER_GUIDE.md` - Emulator user guide

**Category L: Educational Materials**
18. `docs/EDUCATIONAL_CURRICULUM_MATERIALS.md` - Curriculum part 1
...
20. `phase3/PHASE3_COMPLETION_INDEX.md` - Phase 3 overview (index)
21. `phase3/README.md` - Phase 3 quick start
22. `phase3/procedures/PHASE3_MANUFACTURING_PROCEDURES.md` - Manufacturing (5,000+ lines, 40 KB)
23. `phase3/procedures/PHASE3_ASSEMBLY_PROCEDURES_WITH_DIAGRAMS.md` - Assembly (3,000+ lines, 25 KB)
24. `phase3/procedures/PHASE3_QUALITY_CONTROL_VALIDATION.md` - QC procedures (4,000+ lines, 35 KB)
25. `phase3/procedures/PHASE3_OPERATIONAL_MANUAL.md` - Operations (3,500+ lines, 30 KB)
26. `phase3/specifications/PHASE3_COST_TRACKING_RESOURCE_ALLOCATION.md` - Cost tracking (3,500+ lines, 30 KB)

*Phase 4: Integration Testing & Validation (8 weeks)*
27. `phase4/PHASE4_COMPLETION_INDEX.md` - Phase 4 overview (index)
28. `phase4/README.md` - Phase 4 quick start
29. `phase4/testing/PHASE4_COMPONENT_TEST_SPECIFICATIONS.md` - Component testing (8,000+ lines, 60 KB)
30. `phase4/testing/PHASE4_SUBASSEMBLY_INTEGRATION_TESTS.md` - Integration testing (6,000+ lines, 45 KB)
31. `phase4/validation/PHASE4_SYSTEM_OPERATIONAL_VALIDATION.md` - System validation (7,000+ lines, 50 KB)
32. `phase4/acceptance/PHASE4_HANDOFF_ACCEPTANCE_CRITERIA.md` - Acceptance (5,000+ lines, 40 KB)

**Category N: Historical Whitepapers & Exploratory**
33. `whitepaper/WHITEPAPER_DELIVERY_SUMMARY.md` - Whitepaper summary
...
38. `infrastructure/INFRASTRUCTURE_STRATEGY.md` - Infrastructure planning
39. `infrastructure/SIMULATOR_RESEARCH_NOTES.md` - Simulator research
40. `infrastructure/BSD_INTEGRATION_SPEC.md` - BSD integration spec
...
1. **Multiple README files** (5 instances)
   ...
   - `/phase3/README.md` (Phase 3 quick start)
   - `/phase4/README.md` (Phase 4 quick start)
   - `/docs/BABBAGE_README.md` (Babbage quick reference)
...
4. **Whitepaper delivery materials scattered**
   - `whitepaper/WHITEPAPER_DELIVERY_SUMMARY.md`
...
5. **Timeline appears in two formats**
   - `TIMELINE_VISUALIZATION.md` (design concept)
   - `TIMELINE_VISUALIZATION_SPEC.md` (implementation spec)
...
2. **IMPLEMENTATION_ROADMAP.md** references:
   - LANGUAGE_SERVICES_ARCHITECTURE.md (Phase 2 details)
   - SECURITY_LAYERS_IMPLEMENTATION.md (Phase 1.3 details)
   - CONTENT_SCHEMA_DESIGN.md (Phase 3 details)
...
|---|---|---|
| **New Project Members** | README.md, AGENTS.md, PROJECT_STRUCTURE.md, IMPLEMENTATION_ROADMAP.md | 4 docs |
| **Backend Developers** | LANGUAGE_SERVICES_ARCHITECTURE.md, LANGUAGE_SERVICE_SPECIFICATION.md, DOCKER_INFRASTRUCTURE.md | 3 docs |
| **Frontend Developers** | ARCHITECTURE.md, CONTENT_SCHEMA_DESIGN.md, TIMELINE_VISUALIZATION_SPEC.md | 3 docs |
| **Security Engineers** | SECURITY_LAYERS_IMPLEMENTATION.md, DOCKER_INFRASTRUCTURE.md | 2 docs |
...
| **Educators** | TYPE_THEORY_CURRICULUM.md, EDUCATIONAL_CURRICULUM_MATERIALS.md, EXAMPLE_PROGRAMS.md | 3 docs |
...
│   ├── ARCHITECTURE_OVERVIEW.md   (← ARCHITECTURE.md, condensed intro)
│   ├── SYSTEM_ARCHITECTURE.md     (← ARCHITECTURE.md, full technical)
│   ├── PROJECT_STRUCTURE.md       (→ keep as reference)
│   ├── LANGUAGE_SERVICES_ARCHITECTURE.md
│   ├── LANGUAGE_SERVICE_INTERFACE.md (← LANGUAGE_SERVICE_SPECIFICATION.md)
│   ├── SECURITY_ARCHITECTURE.md   (← SECURITY_LAYERS_IMPLEMENTATION.md)
│   ├── DATA_SCHEMA.md             (← CONTENT_SCHEMA_DESIGN.md)
│   ├── TIMELINE_SYSTEM.md         (← TIMELINE_VISUALIZATION.md + SPEC)
│   └── DOCKER_DEPLOYMENT.md       (← DOCKER_INFRASTRUCTURE.md)
│
├── /DEVELOPMENT_GUIDES/           [NEW: How-To and Procedural]
│   ├── SETUP_DEVELOPMENT_ENV.md   (← from WEEK_1_CHECKLIST.md)
│   ├── BUILD_AND_TEST.md          (← BUILD.md)
│   ├── CONTRIBUTING_CODE.md       (← AGENTS.md, expanded)
│   ├── REPOSITORY_WORKFLOW.md     (← AGENTS.md details)
│   ├── IMPLEMENTATION_GUIDE.md    (← IMPLEMENTATION_ROADMAP.md summary)
│   └── TROUBLESHOOTING.md         (NEW: Common issues)
│
├── /CURRICULUM_AND_CONTENT/       [NEW: Educational Materials]
│   ├── TYPE_THEORY_PROGRESSION.md (← TYPE_THEORY_CURRICULUM.md)
│   ├── MODULES_AND_LESSONS.md     (← CONTENT_SCHEMA_DESIGN.md)
...
│   ├── 52_WEEK_ROADMAP.md         (← IMPLEMENTATION_ROADMAP.md, full)
│   ├── WEEKLY_PLANS/              (NEW folder)
│   │   ├── WEEK_1_SUMMARY.md      (← WEEK_1_CHECKLIST.md)
│   │   ├── WEEK_2_SUMMARY.md      (← WEEK_2_IMPLEMENTATION_PLAN.md)
...
│   ├── BUILD_INSTRUCTIONS.md             (← BUILD.md)
│   ├── DOCKER_SETUP.md                   (← DOCKER_INFRASTRUCTURE.md)
...
└── /ARCHIVED_MATERIALS/           [NEW: Historical Documentation]
    ...
    ├── EARLY_PLANNING_DOCUMENTS.md       (← MVP_FILE_STRUCTURE.md)
...
| ARCHITECTURE.md | ARCHITECTURE_AND_DESIGN/SYSTEM_ARCHITECTURE.md | Move | Full technical docs |
| PROJECT_STRUCTURE.md | ARCHITECTURE_AND_DESIGN/ | Copy | Keep as reference |
| IMPLEMENTATION_ROADMAP.md | IMPLEMENTATION_ROADMAP/52_WEEK_ROADMAP.md | Move | Primary roadmap |
| AGENTS.md | DEVELOPMENT_GUIDES/CONTRIBUTING_CODE.md | Move+Expand | Add more details |
| LANGUAGE_SERVICES_ARCHITECTURE.md | ARCHITECTURE_AND_DESIGN/ | Copy | Keep original |
| LANGUAGE_SERVICE_SPECIFICATION.md | ARCHITECTURE_AND_DESIGN/LANGUAGE_SERVICE_INTERFACE.md | Move | Rename for clarity |
| SECURITY_LAYERS_IMPLEMENTATION.md | ARCHITECTURE_AND_DESIGN/SECURITY_ARCHITECTURE.md | Move | Rename |
| DOCKER_INFRASTRUCTURE.md | BUILD_AND_DEPLOYMENT/DOCKER_SETUP.md | Move | Relocate |
| CONTENT_SCHEMA_DESIGN.md | ARCHITECTURE_AND_DESIGN/DATA_SCHEMA.md | Move | Rename |
| TYPE_THEORY_CURRICULUM.md | CURRICULUM_AND_CONTENT/TYPE_THEORY_PROGRESSION.md | Move | Rename |
| TIMELINE_VISUALIZATION.md + SPEC | ARCHITECTURE_AND_DESIGN/TIMELINE_SYSTEM.md | Consolidate | Merge two docs |
| WEEK_1_CHECKLIST.md | ARCHIVED_MATERIALS/WEEK_1_SUMMARY.md | Move | Archive |
| WEEK_2_IMPLEMENTATION_PLAN.md | ARCHIVED_MATERIALS/WEEK_2_SUMMARY.md | Move | Archive |
| ARCHITECTURAL_REVIEW_WEEK2_DAY6.md | ARCHIVED_MATERIALS/CODE_REVIEW_FINDINGS.md | Move | Archive |
| MVP_FILE_STRUCTURE.md | ARCHIVED_MATERIALS/EARLY_PLANNING_DOCUMENTS.md | Move | Archive |
| BUILD.md | BUILD_AND_DEPLOYMENT/BUILD_INSTRUCTIONS.md | Move | Relocate |
| BUILD_INFRASTRUCTURE_COMPLETION_SUMMARY.md | ARCHIVED_MATERIALS/PROJECT_MILESTONES.md | Move | Archive |
| PEDAGOGICAL_WHITEPAPER_COMPLETION_SUMMARY.md | ARCHIVED_MATERIALS/PROJECT_MILESTONES.md | Consolidate | Merge |
| README_OUTPUT.md | ARCHIVED_MATERIALS/DELIVERABLES_INDEX.md | Move | Archive |
| PHASE2_COMPLETION_INDEX.md | BABBAGE_ENGINE_SPECIFICATION/PHASE_2_INFRASTRUCTURE/ | Move | Reorganize |
...
| docs/OPTIMAL_BABBAGE_SPECIFICATION.md | BABBAGE_ENGINE_SPECIFICATION/PHASE_1_ENGINEERING/ENGINEERING_SPECIFICATION.md | Move | PRIMARY - stays large |
| docs/BABBAGE_PROJECT_SUMMARY.md | BABBAGE_ENGINE_SPECIFICATION/PROJECT_OVERVIEW.md | Move+Promote | Executive summary |
| docs/BABBAGE_CRITICAL_REVIEW.md | BABBAGE_ENGINE_SPECIFICATION/PHASE_1_ENGINEERING/ | Move | Design review |
| docs/BABBAGE_README.md | BABBAGE_ENGINE_SPECIFICATION/README.md | Move | Quick reference |
| docs/PROJECT_COMPLETION_SUMMARY.md | BABBAGE_ENGINE_SPECIFICATION/ | Move | Project status |
| docs/HISTORICAL_AUDIT_AND_CORRECTIONS.md | BABBAGE_ENGINE_SPECIFICATION/HISTORICAL_RESEARCH/ | Move | Historical verification |
| docs/HISTORICAL_FICTION_NARRATIVES.md | BABBAGE_ENGINE_SPECIFICATION/HISTORICAL_RESEARCH/ | Move | Narrative materials |
...
| docs/ECONOMIC_MODELS_MASS_PRODUCTION.md | BABBAGE_ENGINE_SPECIFICATION/PHASE_3_MANUFACTURING/ECONOMIC_MODELS.md | Move | Cost models |
| docs/SUPPLY_CHAIN_PROCUREMENT_GUIDE.md | BABBAGE_ENGINE_SPECIFICATION/PHASE_3_MANUFACTURING/SUPPLY_CHAIN.md | Move | Sourcing guide |
| docs/ASSEMBLY_INSTRUCTIONS_PART1.md | BABBAGE_ENGINE_SPECIFICATION/EMULATION_AND_SOFTWARE/ASSEMBLY_INSTRUCTIONS.md | Move | Assembly |
| docs/EXAMPLE_PROGRAMS.md | BABBAGE_ENGINE_SPECIFICATION/EMULATION_AND_SOFTWARE/EXAMPLE_PROGRAMS.md | Copy | Programs |
| docs/OPERATIONS_AND_MAINTENANCE.md | BABBAGE_ENGINE_SPECIFICATION/OPERATIONS_AND_MAINTENANCE/OPERATIONS_GUIDE.md | Move | Operations |
| docs/EMULATOR_SPECIFICATION.md | BABBAGE_ENGINE_SPECIFICATION/EMULATION_AND_SOFTWARE/ | Move | Emulator spec |
| docs/EMULATOR_USER_GUIDE.md | BABBAGE_ENGINE_SPECIFICATION/EMULATION_AND_SOFTWARE/ | Move | User guide |
| docs/EDUCATIONAL_CURRICULUM_MATERIALS.md | BABBAGE_ENGINE_SPECIFICATION/EDUCATIONAL_APPLICATIONS/CURRICULUM_MATERIALS.md | Move | Education |
| docs/EDUCATIONAL_CURRICULUM_MATERIALS_PART2.md | (merge into above) | Consolidate | Combine parts |
| phase3/PHASE3_COMPLETION_INDEX.md | BABBAGE_ENGINE_SPECIFICATION/PHASE_3_MANUFACTURING/PHASE_COMPLETION_INDEX.md | Move | Phase 3 overview |
...
| phase4/PHASE4_COMPLETION_INDEX.md | BABBAGE_ENGINE_SPECIFICATION/PHASE_4_VALIDATION/PHASE_COMPLETION_INDEX.md | Move | Phase 4 overview |
...
- [System architecture](../ARCHITECTURE_AND_DESIGN/SYSTEM_ARCHITECTURE.md)
- [Language services](../ARCHITECTURE_AND_DESIGN/LANGUAGE_SERVICES_ARCHITECTURE.md)
- [Security design](../ARCHITECTURE_AND_DESIGN/SECURITY_ARCHITECTURE.md)
...
- [Full technical architecture](../ARCHITECTURE_AND_DESIGN/SYSTEM_ARCHITECTURE.md)
...
- [Security architecture](../ARCHITECTURE_AND_DESIGN/SECURITY_ARCHITECTURE.md)
...
- **Current**: `TIMELINE_VISUALIZATION.md` + `TIMELINE_VISUALIZATION_SPEC.md` (two files)
...
- **Current**: `PEDAGOGICAL_WHITEPAPER_COMPLETION_SUMMARY.md`, `BUILD_INFRASTRUCTURE_COMPLETION_SUMMARY.md`, `PROJECT_COMPLETION_SUMMARY.md`, `PHASE2_DELIVERY_SUMMARY.md` (4 files)
...
- `WEEK_1_CHECKLIST.md` → Week 1 summary
- `WEEK_2_IMPLEMENTATION_PLAN.md` → Week 2 summary
- `MVP_FILE_STRUCTURE.md` → Early planning documents
...
**Example: IMPLEMENTATION_ROADMAP.md references**

Old: "See LANGUAGE_SERVICES_ARCHITECTURE.md for details on Phase 2 language services"
New: "See [Language Services Architecture](../ARCHITECTURE_AND_DESIGN/LANGUAGE_SERVICES_ARCHITECTURE.md) for details on Phase 2 language services"

**Key relationships to update:**
1. README → ARCHITECTURE.md
2. ARCHITECTURE → LANGUAGE_SERVICE_SPECIFICATION.md
3. IMPLEMENTATION_ROADMAP → SECURITY_LAYERS_IMPLEMENTATION.md
