...
### LANGUAGE_SERVICES_./ARCHITECTURE.md
...
A: Each language service runs in a Docker container with seccomp-bpf syscall filtering, cgroups resource limits, and Linux namespaces. See LANGUAGE_SERVICES_./ARCHITECTURE.md.
